 ...
 * @subpackage WPCLT_Presentations/includes
 */
...
class WPCLT_Presentations {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      WPCLT_Presentations_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - WPCLT_Presentations_Loader. Orchestrates the hooks of the plugin.
	 * - WPCLT_Presentations_i18n. Defines internationalization functionality.
	 * - WPCLT_Presentations_Admin. Defines all hooks for the admin area.
	 * - WPCLT_Presentations_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wpclt-presentations-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wpclt-presentations-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wpclt-presentations-admin.php';
	 ...
	 *
	 * Uses the WPCLT_Presentations_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    WPCLT_Presentations_Loader    Orchestrates the hooks of the plugin.
	 */
