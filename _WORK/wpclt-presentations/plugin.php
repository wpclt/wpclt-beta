...
/*
  ...
  Plugin URI: http://www.wpclt.com
  Description: Presentations Plugin
  Author: Jamie Bowman
  Author URI: http://www.redoma.digital
  Version: {{@version}}
  Text Domain: wpclt
  License: GPLv3
 */
...
if ( ! class_exists( 'WPCLT_Presentations' ) ) {
    /**
     ...
     */
    final class WPCLT_Presentations {

        /**
         * The only instance of the class
         *
         * @var WPCLT_Presentations
         * @since 1.0
         */
