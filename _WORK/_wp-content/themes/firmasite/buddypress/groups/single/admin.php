...
<form action="<?php bp_group_admin_form_action(); ?>" name="group-settings-form" id="group-settings-form" class="standard-form margin-top" method="post" enctype="multipart/form-data" role="main">
