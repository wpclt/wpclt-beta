...
<div id="post-<?php bbp_reply_id(); ?>" <?php bbp_reply_class(bbp_get_reply_id(), array("modal firmasite-modal-static")); ?>><div class="modal-dialog no-margin"><div class="modal-content">
